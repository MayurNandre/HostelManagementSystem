        ...
        <div class="page-wrapper">
            ...
            <div class="page-breadcrumb">
                <div class="row">
                    ...
                    <h2 class="page-title text-center text-dark font-weight-medium mb-1">Full Details</h2>
            ...
            <div class="container-fluid">
              ...
              <!-- Table column end -->
              <a href="generateinvoice.php?id=<?php echo $_GET['id']; ?>" class="btn btn-success btn-block text-monospace">Generate Invoice</a>
