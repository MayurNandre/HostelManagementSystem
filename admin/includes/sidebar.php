...
<nav class="sidebar-nav">
    ...
    <ul id="sidebarnav">
        ...
        class="hide-menu">Student Accounts</span></a></li>
        ...
        <li class="sidebar-item"> <a class="sidebar-link sidebar-link" href="emloyees.php"
        aria-expanded="false"><i class="fas fa-people-carry"></i><span
        class="hide-menu">Emloyees</span></a></li>
