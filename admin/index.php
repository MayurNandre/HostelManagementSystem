...
<head>
    ...
    <link href="../dist/css/style.css" rel="stylesheet"><!-- Plain CSS -->
     <!-- modification by mn -->
      <link href="../dist/css/mycustom.css" rel="stylesheet">
...
<body>
    <div class="main-wrapper">
       <!-- -------------Preloader------------- -->
        ...
        <!-- -------------Login box (loginbox.scss)------------- -->
        <div class="auth-wrapper d-flex no-block justify-content-center align-items-center position-relative"
            style="background:url(../assets/images/big/) no-repeat center center;">
            <div class="my-style auth-box row">
                <div id="loginimg" class="col-lg-7 col-md-5 modal-bg-img" style="background-image: url(../assets/images/adminlogin.jpg);">
                </div>
                <div class="col-lg-5 col-md-7 bg-white">
                    <div class="p-3">
                        <div class="text-center">
                            <img class="hostelLogo" src="../assets/images/big/loginpagelogo.jpg" alt="wrapkit">
                        </div>
                        ...
                        <form class="mt-4" method="POST">
                            <div class="row">
                                ...
                                <div class="col-lg-12 text-center">
                                    <button id="std-lgn-btn" type="submit" name="login" class="btn btn-block btn-danger">LOGIN</button>
                                </div>
                                <div class="col-lg-12 text-center mt-5">
                                   <a href="../index.php" class="text-danger">Go to Student Login</a>
                                </div>
                            </div>
                        </form>
                    </div>
