        ...
        <div class="page-wrapper">
            ...
            <div class="page-breadcrumb">
                <div class="row">
                    ...
                    <h2 class="text-center page-title text-dark font-weight-medium mb-1">Hostel Student Management</h2>
                            ...
                            <div class="card-body">
                                ...
                                <div class="table-responsive">
                                    ...
                                    <thead class="thead-dark">
                                        ...
                                        <td><?php 
                                        if($row->fee_status=="0"){
                                            echo "<p class='text-danger'>NOT PAID</p>";
                                        }else{
